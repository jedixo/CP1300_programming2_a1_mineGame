...
public class SizeDialog extends JDialog {
	...
	private static final int MAX = 20; // theoretical max of 99
	...
	public SizeDialog() {
		...
		rowsSlider = new JSlider(JSlider.HORIZONTAL, MIN, MAX, INITIAL);
		columsSlider = new JSlider(JSlider.HORIZONTAL, MIN, MAX, INITIAL);
